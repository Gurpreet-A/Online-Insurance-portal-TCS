...
<form name="viewPropWithoutPrem" method="post" action="./UnderWriterController">
...
PreparedStatement pst=conn.prepareStatement("select * from createproposal_test1");
...
<tr>
<td>Enter ID</td>
<td><input type="number" name="proposal" /></td>
</tr>
<tr>
<td></td>
<td><input type="submit" value="generatePremium" /></td>
<td><input type="hidden" value="generatePremium" name="action"/></td>
